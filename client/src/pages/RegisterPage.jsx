      ...
      <div className="w-full max-w-sm border border-zinc-300 bg-white p-8 rounded-none relative shadow-[4px_4px_0px_0px_rgba(0,0,0,0.05)]">
        ...
        <div className="mb-6 font-mono">
          ...
          <p className="text-xs text-zinc-400 mt-1 uppercase">
            credentials: set_parameters
          </p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-[10px] font-semibold text-zinc-500 uppercase tracking-wider mb-1.5 font-mono">
              name
            </label>
            <input
              id="name"
        ...
        {success && (
          <div className="p-2.5 rounded-none bg-emerald-50 border border-emerald-250 text-xs text-emerald-600 font-mono mt-4 text-center">
            {success}
          </div>
        )}
        ...
        <p className="text-center text-xs text-zinc-400 mt-6 font-mono uppercase">
          have account?{' '}
          <Link to="/login" className="text-purple-600 hover:text-purple-700 font-bold underline underline-offset-4 transition-colors">
            login
          </Link>
        </p>
      </div>
